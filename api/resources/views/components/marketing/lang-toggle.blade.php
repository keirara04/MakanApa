...
<button type="button" id="lang-toggle" hidden
        class="inline-flex min-h-10 min-w-10 items-center justify-center gap-1.5 rounded-full border border-ink/20 bg-paper-50/70 px-2.5 text-sm sm:px-3 font-semibold text-ink transition hover:border-ink/60">
    {{-- Lucide "languages" --}}
